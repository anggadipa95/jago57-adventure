      ...
      (entry, index) => {
        ...
        const text =
          this.add.text(
            260,
            y,
            `${index + 1}.   ${entry.name || "PLAYER"}      ${entry.score || 0}      W ${entry.levelId || "-"}`,
            {
              fontFamily:
                "Arial",
...
class GameScene extends Phaser.Scene {
  ...
  // =====================================================
  // MOBILE CONTROLS
  // HTML TOUCH BUTTONS - FIX IPHONE MULTITOUCH
  // =====================================================

  createDomMobileControls() {
    this.removeDomMobileControls();
    ...
    right.style.left =
      "max(112px, calc(env(safe-area-inset-left) + 112px))";
